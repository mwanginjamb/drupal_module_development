...
class __TwigTemplate_057ce916d8a47e70e44e28eff1bb587e extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 23
        if ( !Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trimFilter(Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(($context["title"] ?? null)))))) {
            // line 24
            yield "  <h1";
