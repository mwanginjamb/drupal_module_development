...
class __TwigTemplate_59c2e1f85fc5b1e52ce0e5b3f27e081e extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 24
        if (Twig\Extension\CoreExtension::lengthFilter($this->env, ($context["tips"] ?? null))) {
            // line 25
            yield "  ";
            if (($context["multiple"] ?? null)) {
                // line 26
...
$context["name"], 34, $this->source)))];
    ...
    ";
                // line 43
                if (Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["tip"], "list", [], "any", false, false, true, 43))) {
                    // line 44
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/filter/filter-tips.html.twig", "/var/www/html/drupal/core/themes/olivero/templates/filter/filter-tips.html.twig");
    }
