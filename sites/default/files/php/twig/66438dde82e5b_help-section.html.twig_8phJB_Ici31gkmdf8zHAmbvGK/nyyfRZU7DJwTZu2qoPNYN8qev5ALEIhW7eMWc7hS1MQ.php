...
class __TwigTemplate_5b092495877ef5e0d74dbfcd899c105c extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        if (($context["links"] ?? null)) {
            ...
            // line 20
            yield "    ";
            $context["size"] = (int) floor((Twig\Extension\CoreExtension::lengthFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["links"] ?? null), 20, $this->source)) / 4));
            // line 21
            yield "    ";
            if (((($context["size"] ?? null) * 4) < Twig\Extension\CoreExtension::lengthFilter($this->env, ($context["links"] ?? null)))) {
                // line 22
                yield "      ";
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/classy/misc/help-section.html.twig", "/var/www/html/drupal/core/themes/claro/templates/classy/misc/help-section.html.twig");
    }
