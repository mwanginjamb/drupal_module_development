...
class __TwigTemplate_24edbfbb7f80ba0b8d6454ed845f11aa extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 35
        $context["classes"] = ["views-table", "views-view-table", ("cols-" . Twig\Extension\CoreExtension::lengthFilter($this->env, $this->sandbox->ensureToStringAllowed(        // line 38
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, $context["column"], "default_classes", [], "any", false, false, true, 93)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                        // line 100
                        yield "              ";
                        $context["column_classes"] = Twig\Extension\CoreExtension::arrayMerge($this->sandbox->ensureToStringAllowed(($context["column_classes"] ?? null), 100, $this->source), [("views-field-" . $this->sandbox->ensureToStringAllowed($context["field"], 100, $this->source))]);
                        // line 101
                        yield "            ";
                    }
                    $_parent = $context['_parent'];
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/views/views-view-table.html.twig", "/var/www/html/drupal/core/themes/claro/templates/views/views-view-table.html.twig");
    }
